 ...
 local chienchaud2 = ClientsideModel("models/Gibs/HGIBS.mdl")
        chienchaud2:SetNoDraw(true)
        chienchaud2:SetModelScale(120)
        timer.Create("charglogo2", 0.01, 0, function()
          chienchaud2:SetAngles(Angle(90, CurTime()*90 % 360 ,90) )
        end)
        local data2 = {}
        ...
        hook.Add("PostDrawOpaqueRenderables","\xFFitsrainingchienchauds2\xFF",function()
          ...
          for i=1, #data2 do
            ...
            data2[i][1].z = data2[i][1].z - data2[i][2] / 20
